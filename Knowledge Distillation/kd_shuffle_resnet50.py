...
from util.exp_shuffle import input_shuffle
from PIL import Image
import torch.optim as optim
from model import net, channle_expend_net
from model.net import InvertedResidual_ca, InvertedResidual_se, MyNet
from util.rank_moudle import CBAM, rank, privacy_entropy
from util.time_utils import time_for_file, print_log
from util.visualization import draw_loss_and_accuracy, plot_confusion_matrix
import numpy as np
...
def train(train_epoch,  learning_rate_start):
    ...
    for epoch in range(train_epoch):
        ...
        for inputs, target in loop:
            ...
            inputs = rank(inputs, channel_w, spatial_w, 32)
